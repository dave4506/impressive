...
class Add extends React.Component {
  ...
  render() {
    ...
    return <div className={`${b["block"]} ${b["block__standard-width"]} ${s["block-add"]}`}>
      <div className={`${s["block-tools"]}`}>
        ...
        <div className={`${s["block-buttons"]} ${s["block-buttons__"+(addButton ? "open":"close")]}`}>
          ...
          <div onClick={()=>{onClick("icons")}} className={`${s["block-buttons-row"]}`}>
            <div>
